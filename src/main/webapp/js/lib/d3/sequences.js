...
d3.text("/bdo/data/d", function(text) {
  ...
  createVisualization(json);
    ...
    $id.d3Click();
    console.log("**************************")
    console.log(randomId, ids[randomId], $id)
    console.log("**************************")
    ...
    //svg.select(ids[1]).on("click")();
    //console.log( svg.select("#" + ids[0]))

    // var interval = setInterval(function(){
    //     console.log('here...')
    //     console.log(svg.select("#" + ids[randomId]))
    //     svg.select("#" + ids[randomId]).on("click")();
    // }, 3000)

    //clearInterval(interval)
});

// d3.csv("http://localhost:9463/abcr/static/js/lib/d3/visit-sequences.csv", function(data){
