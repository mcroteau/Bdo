...
<g:if test="${flash.message}">
    ...
    <style type="text/css">
        ...
        .salesman-stats-label{
            font-weight:normal;
        }
        #prospects-by-statuses{
            border-top:dashed 1px #ddd;
            border-bottom:dashed 1px #ddd;
        }
        .prospect-status-container{
            float:left;
            margin:5px 27px;
        }
...
<h1 style="text-align:center;margin:10px auto 5px;background:#efefef; padding:20px;">Company Overview
    <select class="form-control" id="dashboard-select">
        <option value="ALL" selected>All Data</option>
        <option value="SALESMAN">Salesman Data</option>
    </select>
    <br class="clear"/>
</h1>
...
<div id="prospects-by-statuses">
    <g:each in="${statuses}" var="status">
        <div class="prospect-status-container">
            <span class="prospect-status-label">
                ${status.name}
            </span>
            <span class="prospect-status-value">
                ${status.count}
            </span>
        </div>
    </g:each>
...
<div id="date-selectors" style="text-align:center;display:block; padding:10px 20px; border:solid 0px #ddd;">
    <g:form controller="overview" action="index" method="get" class="range-form">
        ...
        <g:link controller="overview" action="index" params="[ allData : true ]" class="btn btn-default all-data">All Data</g:link>
    </g:form>
</div>



<div id="sales-stats-outer-container" class="pull-left" style="border:solid 0px #ddd;">

    <div class="sales-stats-container" style="border:solid 0px #ddd;">
        <div class="sales-stats-left sales-stat-value pull-left"  style="border:solid 0px #ddd;">
    ...
    <div class="sales-stats-container">
        <div class="sales-stats-left sales-stat-value pull-left">
            ...
            ${applicationService.formatPrice(data.salesTotal)}
        </div>
        <div class="sales-stats-right pull-left">
            Sales<br/>Total
        </div>
    ...
    <div class="sales-stats-container">
        <div class="sales-stats-left sales-stat-value pull-left">
            <span class="sales-stat-dollar">$</span>
            ${applicationService.formatPrice(data.averageSale)}
        </div>
        <div class="sales-stats-right pull-left">
            Average<br/>Sale
        </div>
    ...
    <div class="conversion-rate-container" style="text-align:center; margin-left:auto;margin-right:auto; width:300px;">
        <div class="conversion-rate pull-left" style="display:inline-block;">
            ${data.conversionRate}<span>%</span>
        </div>
        <div class="conversion-rate-description pull-left" style="display:inline-block;">
            Conversion<br/>Rate
        </div>
        <br class="clear"/>
    </div>
...
<div id="top-producing" style="margin:40px 0px 20px 0px;">
    <h1>Top Producing Sales People</h1>
    <%def index = 0%>
    <table class="table" style="width:570px;margin:20px 0px;">
        <g:each in="${salesmen}" var="salesman">
            <g:if test="${index < 3}">
                <tr>
                    <th colspan="2"><span class="salesman-stats-label">${salesman.name}</span></th>
                </tr>
                <tr style="background:#efefef;">
                    <th>
                        <span class="salesman-stats-label">Sales Actions :</span>
                        <span class="salesman-stat">${salesman.actions}</span>
                    </th>
                    <th>
                        <span class="salesman-stats-label">Sales :</span>
                        <span class="salesman-stat">${salesman.sales}</span>
                    </th>
                </tr>
            </g:if>
            <%index++%>
...
<h1 style="margin-top:70px;">Sales Efforts</h3>
